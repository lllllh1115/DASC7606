...
optimizer = dict(
    ...
    lr=6e-4, # Tune the base learning rate
)
...
model = dict(
    type='TopDown',
    pretrained='https://download.openmmlab.com/mmpose/animal/hrnet/'
...
train_pipeline = [
    ...
    dict( type='TopDownHalfBodyTransform', # TopDownHalfBodyTransform 数据增强的配置
